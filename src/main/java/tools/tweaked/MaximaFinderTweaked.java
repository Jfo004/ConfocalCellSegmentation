 ...
 * @author thomasb
 */
public class MaximaFinderTweaked {
     ...
     */
    public MaximaFinderTweaked(ImageHandler ima, float noiseTolerance) {
        img = ima.duplicate();
     ...
     * @param noiseTolerance The noise tolerance
     */
    public MaximaFinderTweaked(ImageHandler img, float radXY, float radZ, float noiseTolerance) {
        this.img = img;
        this.noiseTolerance = noiseTolerance;
        this.radXY = radXY;
        this.radZ = radZ;
     ...
     * @param ima The raw image
     */
    public MaximaFinderTweaked(ImageHandler ima) {
        img = ima.duplicate();
        noiseTolerance = 0;
    }
