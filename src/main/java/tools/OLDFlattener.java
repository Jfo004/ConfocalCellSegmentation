...
public class OLDFlattener {
     ...
     */
    public OLDFlattener(String targetLoc, String outLoc, boolean isDir, int pMethod, int tileSize, boolean nameChannels, boolean makeComp, double[][] channelInt, double[][] compInt) {
     ...
     */
    public OLDFlattener(String targetLoc, String outLoc, boolean isDir, int pMethod, int tileSize, boolean nameChannels, boolean makeComp, int calImg)  {
        this.outputLocation = outLoc;
        this.zProjectionMethod = pMethod;
        this.tileSize = tileSize;
        this.nameChannels = nameChannels;
     ...
     * @param makeComp True if a composite of all channels should be constructed
     */
    public OLDFlattener(String targetLoc, String outLoc, boolean isDir, int pMethod, int tileSize, boolean nameChannels, boolean makeComp) {
        this.outputLocation = outLoc;
        this.zProjectionMethod = pMethod;
        this.tileSize = tileSize;
        this.nameChannels = nameChannels;
