...
public class OpenExperimentGUI extends javax.swing.JDialog {
     ...
     */
    public OpenExperimentGUI(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpenExperimentGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OpenExperimentGUI dialog = new OpenExperimentGUI(new javax.swing.JFrame(), true);
